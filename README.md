...
2. Click on the following link: [AWS Serverless Application Repository](https://serverlessrepo.aws.amazon.com/applications/eu-central-1/028938425188/Serverless-Goat-Java
   )
3. Click `Deploy`
...
# Deploying to AWS Serverless Application Repository

See contents of `sar` folder. Especially the [README.md](sar/README.md).
